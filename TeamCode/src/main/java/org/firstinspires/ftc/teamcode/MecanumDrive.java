...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = -0.0225136;
        //try making positive to see if it works, but then make everything else like that too
        public double lateralInPerTick = -0.0220313;
